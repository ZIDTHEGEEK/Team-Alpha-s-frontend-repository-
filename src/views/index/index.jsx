    ...
    return (
        <div className="bg-white min-h-screen flex">
            ...
            <div className="flex-grow p-10 flex flex-col justify-center">
                <div className="flex items-center">
                    <div>
                        <h1 className="text-4xl font-bold text-gray-800">
                            Build a secure, private, and community-driven email platform where users have full control over data and identity.
                        </h1>
                ...
                {/* Button Container */}
                <div className="mt-6">
                    <a href="/create-account" className="bg-blue-500  text-white py-2 px-4 rounded hover:bg-blue-600 transition">Create New Account</a>
                    <a href="/login" className="ml-4 text-blue-500">I Already Have an Account</a>
                </div>
            </div>
